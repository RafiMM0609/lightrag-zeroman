...
export type LightragStatus = {
  ...
  webui_logo_type?: string
  webui_logo_url?: string
  webui_theme_color?: string
}
    ...
    try {
      ...
      if (response.data.access_token && !response.data.auth_configured) {
        ...
        useAuthStore.getState().login(
          ...
          response.data.webui_logo_type || null,
          response.data.webui_logo_url || null,
          response.data.webui_theme_color || null
        );
        return newToken;
      } else {
