...
webui_logo_type = os.getenv("WEBUI_LOGO_TYPE", "default")
webui_logo_url = os.getenv("WEBUI_LOGO_URL", "")
webui_theme_color = os.getenv("WEBUI_THEME_COLOR", "")
    ...
    async def get_auth_status():
        ...
        if not auth_handler.accounts:
            ...
            return {
                ...
                "webui_logo_type": webui_logo_type,
                "webui_logo_url": webui_logo_url,
                "webui_theme_color": webui_theme_color,
            }
